...
public class ArchaiusConfigFactory {
	...
	public static ArchaiusBrokerClientProperties load() {
		return load("broker");
	}

	public static ArchaiusBrokerClientProperties load(String configname) {
		try {
			LayeredConfig layeredConfig = new DefaultLayeredConfig("layered-broker-broker");
			...
			return factory.newProxy(ArchaiusBrokerClientProperties.class, ArchaiusBrokerClientProperties.CONFIG_PREFIX);
		}
